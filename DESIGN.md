...
The signature move is the warm neutral palette and editorial pacing. Combined with organic, hand-drawn-feeling illustrations in terracotta (`#c96442`), black, and muted green, the visual language says "thoughtful companion" rather than "powerful tool." Headlines use system-ui at weight 500, breathing at tight-but-comfortable line-heights (1.10–1.30), creating a cadence that feels more like reading an essay than scanning a product page.

What makes Claude's design truly distinctive is its warm neutral palette. Every gray has a yellow-brown undertone (`#5e5d59`, `#87867f`, `#4d4c48`) — there are no cool blue-grays anywhere. Borders are cream-tinted (`#f0eee6`, `#e8e6dc`), shadows use warm transparent blacks, and even the darkest surfaces (`#141413`, `#30302e`) carry a barely perceptible olive warmth. This chromatic consistency creates a space that feels lived-in and trustworthy.

**Key Characteristics:**
- Warm parchment canvas (`#f5f4ed`) evoking premium paper, not screens
- System type stack: system-ui for all text (headlines + UI), ui-monospace for code
- Terracotta brand accent (`#c96442`) — warm, earthy, deliberately un-tech
- Exclusively warm-toned neutrals — every gray has a yellow-brown undertone
- Organic, editorial illustrations replacing typical tech iconography
- Ring-based shadow system (`0px 0px 0px 1px`) creating border-like depth without visible borders
- Magazine-like pacing with generous section spacing and weight-driven hierarchy
...
### Font Family
- **All text**: `system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Arial, sans-serif`
- **Code**: `ui-monospace, "Cascadia Code", "SF Mono", Consolas, monospace`

### Hierarchy

| Role | Font | Size | Weight | Line Height | Letter Spacing | Notes |
|------|------|------|--------|-------------|----------------|-------|
| Display / Hero | system-ui | 64px (4rem) | 500 | 1.10 (tight) | normal | Maximum impact, book-title presence |
| Section Heading | system-ui | 52px (3.25rem) | 500 | 1.20 (tight) | normal | Feature section anchors |
| Sub-heading Large | system-ui | 36–36.8px (~2.3rem) | 500 | 1.30 | normal | Secondary section markers |
| Sub-heading | system-ui | 32px (2rem) | 500 | 1.10 (tight) | normal | Card titles, feature names |
| Sub-heading Small | system-ui | 25–25.6px (~1.6rem) | 500 | 1.20 | normal | Smaller section titles |
| Feature Title | system-ui | 20.8px (1.3rem) | 500 | 1.20 | normal | Small feature headings |
| Body Editorial | system-ui | 17px (1.06rem) | 400 | 1.60 (relaxed) | normal | Editorial body text passages |
| Body Large | system-ui | 20px (1.25rem) | 400 | 1.60 (relaxed) | normal | Intro paragraphs |
| Body / Nav | system-ui | 17px (1.06rem) | 400–500 | 1.00–1.60 | normal | Navigation links, UI text |
| Body Standard | system-ui | 16px (1rem) | 400–500 | 1.25–1.60 | normal | Standard body, button text |
| Body Small | system-ui | 15px (0.94rem) | 400–500 | 1.00–1.60 | normal | Compact body text |
| Caption | system-ui | 14px (0.88rem) | 400 | 1.43 | normal | Metadata, descriptions |
| Label | system-ui | 12px (0.75rem) | 400–500 | 1.25–1.60 | 0.12px | Badges, small labels |
| Overline | system-ui | 10px (0.63rem) | 400 | 1.60 | 0.5px | Uppercase overline labels |
| Micro | system-ui | 9.6px (0.6rem) | 400 | 1.60 | 0.096px | Smallest text |
| Code | ui-monospace | 15px (0.94rem) | 400 | 1.60 | -0.32px | Inline code, terminal |

### Principles
- **Weight for authority**: Headlines use weight 500 — no bold, no light. This creates a consistent "voice" across all heading sizes.
...
- **Weight-driven rhythm**: The heavier headline weights establish a literary cadence that demands more whitespace than body text.
...
- Use system-ui at weight 500 for all headlines — single-weight consistency is intentional
...
- Maintain weight hierarchy — 500 for headlines, 400 for body, system-ui throughout
...
- Don't use bold (700+) weight for headlines — weight 500 is the ceiling
...
- Don't use monospace fonts for non-code content — ui-monospace is strictly for code
...
- "Create a hero section on Parchment (#f5f4ed) with a headline at 64px system-ui weight 500, line-height 1.10. Use Anthropic Near Black (#141413) text. Add a subtitle in Olive Gray (#5e5d59) at 20px system-ui with 1.60 line-height. Place a Terracotta Brand (#c96442) CTA button with Ivory text, 12px radius."
- "Design a feature card on Ivory (#faf9f5) with a 1px solid Border Cream (#f0eee6) border and comfortably rounded corners (8px). Title in system-ui at 25px weight 500, description in Olive Gray (#5e5d59) at 16px system-ui. Add a whisper shadow (rgba(0,0,0,0.05) 0px 4px 24px)."
- "Build a dark section on Anthropic Near Black (#141413) with Ivory (#faf9f5) headline text in system-ui at 52px weight 500. Use Warm Silver (#b0aea5) for body text. Borders in Dark Surface (#30302e)."
...
- "Design a model comparison grid with three cards on Ivory surfaces. Each card gets a Border Warm (#e8e6dc) top border, model name in system-ui at 25px, and description in Olive Gray at 15px system-ui."
...
4. Specify weight explicitly — "system-ui weight 500 for the heading, weight 400 for the label"
